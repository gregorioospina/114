...
const Footer = () => {
	const socialLinks = [
		...
		{ href: "https://www.facebook.com/profile.php?id=61587473771876", icon: <SiFacebook className="w-6 h-6" />, label: "Facebook" },
	...
	return (
		<>
			<div className="md:max-h-70 pb-10 px-0 flex justify-center">
				<Image src="/assets/banner-wider.jpg" alt="footer 114" className="object-contain" width={1200} height={280} sizes="(max-width: 768px) 100vw, 1200px" />
			</div>
